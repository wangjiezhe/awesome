...
networkmenu = {
   ...
   { "Firef&ox Developer", "firefox-developer --class firefox-developer", app48 .. "firefox-developer.png" },
...
graphicmenu = {
   { "&GIMP", "optirun gimp", app48 .. "gimp.png" },
   { "&Inkscape", "optirun inkscape", app48 .. "inkscape.png" },
   { "K&rita", "optirun krita", app48 .. "calligrakrita.png" },
   { "&Blender", "optirun blender", app48 .. "blender.png" },
   { "&OBS", "optirun obs", app256 .. "obs.png" },
   { "&FreeCAD", "optirun freecad", app48 .. "freecad.png" },
   { "&OpenSCAD", "optirun openscad", pixmaps .. "openscad.png" },
   { "&Darktable", "optirun darktable", app48 .. "darktable.png" },
...
gamemenu = {
   ...
   { "&OpenRA", "optirun openra", app48 .. "openra-ra.png" },
...
othermenu = {
   ...
   { "Manage &Printing", "xdg-open http://localhost:631/", app48 .. "cups.png" },
   { "&WebCam", webcammenu },
   { "&Bluetooth", "blueman-manager", app48 .. "blueman.png" },
   { "&Passwords and Keys", "seahorse", app48 .. "seahorse.png" },
   { "&Font Editor", "fontforge", app48 .. "fontforge.png" },
